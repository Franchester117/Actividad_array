...
public class ControladorExamples {
    ...
    public int numeroRegistro(){     
        System.out.println(Cli.ANSI_RED+"Contando registros, espere..."+Cli.ANSI_RESET);
        ...
        System.out.println(Cli.ANSI_RED+"Numero de registros encontrados: " + n+Cli.ANSI_RESET);
        return n;
    }
    ...
    public Examples[] obtenerRegistros(int n){
        ...
        try {
            ...
            respuesta = sentenciaSQL.executeQuery();
            System.out.println(Cli.ANSI_RED+"Cargando registros, espere..."+Cli.ANSI_RESET);
            ...
            System.out.println(Cli.ANSI_RED+"Registros cargados"+Cli.ANSI_RESET);
            System.out.println(Cli.ANSI_RED+"Tiempo de ejecucion total: " + (double)((t2-t1)/1000) + " segundos." + Cli.ANSI_RESET);
        }catch (SQLException e){
            System.out.println("Error " + e.getMessage());
        }
        return registros;
    ...
    public void buscarRegistrosDate(Examples[] registro, String date){
        ...
        long t2 = System.currentTimeMillis();
        System.out.println(Cli.ANSI_RED+"\n\nNumero de registros encontrados = " + encontrado+Cli.ANSI_RESET);
        System.out.println(Cli.ANSI_RED+"Tiempo de ejecucion total: " + (double)((t2-t1)/1000) + " segundos." + Cli.ANSI_RESET);
    }
    ...
    public void mostrarRegistrosPorGender(Examples[] registros, String orden)throws NullPointerException{
        ...
        if(orden.equalsIgnoreCase("asc")){
            System.out.println(Cli.ANSI_RED+"Ordenamiento por Gender - Modo ascendente"+Cli.ANSI_RESET);
            ...
            System.out.println(Cli.ANSI_RED+"Ordenamiento por Gender - Modo descendente"+Cli.ANSI_RESET);
            for(int i=0; i<registros.length-1; ++i){
                for(int j=i+1; j<registros.length; ++j){
    ...
    public void mostrarRegistrosPorDate(Examples[] registros, String orden){
        ...
        if(orden.equalsIgnoreCase("asc")){
            System.out.println(Cli.ANSI_RED+"Ordenamiento por Date - Modo ascendente"+Cli.ANSI_RESET);
            for(int i=0; i<registros.length-1; ++i){
                for(int j=i+1; j<registros.length; ++j){
            ...
            System.out.println(Cli.ANSI_RED+"Ordenamiento por Date - Modo descendente"+Cli.ANSI_RESET);
            for(int i=0; i<registros.length-1; ++i){
                for(int j=i+1; j<registros.length; ++j){
